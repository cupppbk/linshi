...
[task_local]
#超级直播间红包雨
30,31 20-23/1 21 1 * https://raw.githubusercontent.com/shylocks/Loon/main/jd_live_redrain.js, tag=超级直播间红包雨, img-url=https://raw.githubusercontent.com/yogayyy/Scripts/master/Icon/shylocks/jd_live_redrain2.jpg, enabled=true

================Loon==============
[Script]
cron "30,31 20-23/1 21 1 *" script-path=https://raw.githubusercontent.com/shylocks/Loon/main/jd_live_redrain.js, tag=超级直播间红包雨
...
============小火箭=========
超级直播间红包雨 = type=cron,script-path=https://raw.githubusercontent.com/shylocks/Loon/main/jd_live_redrain.js, cronexpr="30,31 20-23/1 21 1 *", timeout=200, enable=true
 */
...
if ($.isNode()) {
  ...
  if(JSON.stringify(process.env).indexOf('GITww')>-1) process.exit(0)
}else {
